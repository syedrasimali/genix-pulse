    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/30" style={{ background: "hsl(212 100% 4% / 0.7)", backdropFilter: "blur(16px)" }}>
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 h-16">
        ...
        <div className="flex items-center gap-3">
          <Link to="/login" className="hidden sm:flex text-sm text-muted-foreground hover:text-foreground transition-colors px-3 py-2">Sign In</Link>
          <Link to="/signup" className="hidden sm:flex btn-primary items-center gap-2 text-sm py-2 px-4"><Zap className="w-4 h-4" />Get Started Free</Link>
